...
import UrbanPlanningOverlay from './UrbanPlanningOverlay';
import { getLevelFromWorkers } from '../economy/districtStats';

// Import our new components
import CustomDistrictsLayer from '../map/CustomDistrictsLayer';
import CustomDistrictPopup from '../ui/CustomDistrictPopup';
import DistrictListPanel from '../ui/DistrictListPanel';
import InfluenceLayer from '../map/InfluenceLayer';
import StreetLogisticsLayer from '../map/StreetLogisticsLayer';
import TerrainDefenseLayer from '../map/TerrainDefenseLayer';
...
export default function GameMap({ activeMapLayers = [] }) {
  ...
  useEffect(() => {
    ...
    setIsExpanding(true);
    import('../planning/districtExpansion').then(({ proposeExpansion }) => {
  ...
  const handleConfirmPlacement = async () => {
    ...
    const { findSafeMainBuildingPoint } = await import('../planning/districtValidation');
    ...
    const { getActiveBalanceConfig } = await import('../economy/economyEngine');
  ...
  const handleConfirmExpansion = async () => {
    ...
    const { combineDistrictPolygons } = await import('../planning/districtExpansion');
    const { findSafeMainBuildingPoint } = await import('../planning/districtValidation');
